//Fri Oct 31 2025 14:05:49 GMT+0000 (Coordinated Universal Time)
//Base:<url id="cv1cref6o68qmpt26ol0" type="url" status="parsed" title="GitHub - echo094/decode-js: JS混淆代码的AST分析工具 AST analysis tool for obfuscated JS code" wc="2165">https://github.com/echo094/decode-js</url>
//Modify:<url id="cv1cref6o68qmpt26olg" type="url" status="parsed" title="GitHub - smallfawn/decode_action: 世界上本来不存在加密，加密的人多了，也便成就了解密" wc="741">https://github.com/smallfawn/decode_action</url>
console.log("#不会抓包用这个 https://pan.quark.cn/s/5995097eccc5  " + "入口: 快手极速版App 一机一号一个实名 只限安卓机器 （无需root） 最好一号一ip\n" + "#   需抓取数据:\n" + "#   * 登录时搜索 api_client_salt 找到5kb左右的链接 在响应里最下面找到你的salt 不会可以用一键抓取\n" + "#   * 开抓包点福利后 搜索 earn/overview/tasks 找到此请求的cookie 同时找到此请求下的请求头的user-agent的值\n" + "#   抓包工具 https://pan.quark.cn/s/44f90724e243\n" + "#   * 代理推荐：通过注册链接注册后，一对一成为您的专属代理，注册后提供账号，为您设置最优价格\n" + "#   https://www.xiequ.cn/index.html?d630539f 注册送10元免费使用长效独享代理一天\n" + "#  http://www.gzsk5.com/#/register?invitation=hnking2&shareid=516 光子sk5代理100M 4.5一条" + "#   http://www.tianxingip.com/proxy/index/index/code/hnking/p/2847.html 天行sk5代理 5一条\n");
const domains = ['http://cjupgscn.xsian.top', 'https://ksapi.changjuyi.com'];
